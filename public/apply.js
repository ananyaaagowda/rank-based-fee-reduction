...
app.post('/submit_form', (req, res) => {
    const { aadhar,name,par_name,par_phn,col_name,branch,col_id} = req.body;
    ...
    const sql = 'INSERT INTO APPLICATION ( aadhar,name,par_name,par_phn,col_name,branch,col_id) VALUES (?, ?, ?, ?, ?, ?, ?)';
    db.query(sql, [ aadhar,name,par_name,par_phn,col_name,branch,col_id], (err, result) => {
        if (err) {
